/******************************************************************************
 ...
 (Calculating a Circle’s Diameter, Circumference and Area) Write a program that 
 reads the radius of a circle (as a double value) and computes and prints the 
 diameter, the circumference and the area. Use the value 3.14159 for π.
